...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FILTER_PROPERTY_CODE" => array(
			0 => "MIN_POSTAVKA",
			1 => "KOMPLEKTATSIYA_KHOLODILNIKA",
			2 => "TSVET_KHOLODILNIKA",
			3 => "EKSPEDITOR",
			4 => "CML2_ARTICLE",
			5 => "CML2_BASE_UNIT",
			6 => "VID_SOKA",
			...
			10 => "CML2_ATTRIBUTES",
			11 => "CML2_BAR_CODE",
			12 => "OBEM_UPAKOVKI_LITRY",
			13 => "TIP_KHLEBA",
			14 => "CHISLO_ZHIL",
			15 => "SECHENIE_KV_MM",
			16 => "NARUZHNYY_DIAMETR_KV_MM",
			17 => "RASCHETNAYA_MASSA_KG_KM",
			18 => "",
		),
